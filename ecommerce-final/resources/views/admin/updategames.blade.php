...
<h1 class="title">Update Games</h1>


<form action="{{url('updategame',$data->id)}}" method="post" enctype="multipart/form-data">
        @csrf
...
<div class="pdg">
    ...
    <img class="lbll" height="60" width="120" src="/gameimage/{{$data->image}}" alt="">
